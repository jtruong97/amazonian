...
Revision ID: d6046250f4e0
Revises:
Create Date: 2024-03-26 19:06:57.821979
...
def upgrade():
    ...
    sa.Column('category', sa.Enum('Fern', 'Flower', 'Shrub', 'Succulent', 'Tree', 'Vine'), nullable=False),
